package com.ilongross.patterns.home_works.lab11.cqrs_event;
...
public class AccountService {
    ...
    public void undoCommand(int entityId) {
        var event  = new AccountEvent(AccountEventType.UNDO, entityId, new UndoData(entityId));
